...
Run `dotnet --version` and look for `2.2.103` (or newer) to verify success
...
# Running "docker --version" should display "Docker version 18.09.1, build 4c52b90" or similar
